...
def min():
	...
	venue_name = { }
	timing_path = "/html/body/section[1]/div[2]/div/ul/li[1]/div[2]/div[2]/div[{}]".format(c)
	#while len(driver.find_elements_by_xpath(timing_path)) > 0 :
	timing_container = len(driver.find_elements_by_class_name("showtime-pill-wrapper"))
	print(timing_container)
	...
	print(timing_value)
	#for i in range (1,10):
	price_min = check_pricing("/html/body/section[1]/div[2]/div/ul/li[1]/div[2]/div[2]/div[1]")
